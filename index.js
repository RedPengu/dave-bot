...
client.on("channelDelete", (channel) => {
    if (channel.parentID == channel.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
        ...
        let yembed = new discord.MessageEmbed()
            ...
            .setColor('RED')
            .setDescription("Please do not respond to this message unless you need any more help")
...
client.on("message", async message => {
    ...
    if (message.guild) {
        ...
        if (command == "setup") {
            ...
            if (!category) {
                return message.channel.send("Modmail system is not setup in this server, use " + prefix + "setup")
            }
            ...
            let embed = new discord.MessageEmbed()
                ...
                .addField("Members:"," Dm the bot for help.")

                .addField("Staff:"," Type `{prefix}close` to close support with that user `{prefix}open {user id goes here}` to have the bot dm that user and `{prefix}setup` to setup the bot")
                .setThumbnail(client.user.displayAvatarURL())
    ...
    if (!message.guild) {
        ...
        if (!main) {
            ...
            let sembed = new discord.MessageEmbed()
                ...
                .setColor("GREEN")
                .setThumbnail(client.user.displayAvatarURL())
                .setDescription("Conversation is now started, you will be contacted by staff shortly.")
